...
ssh -o StrictHostKeyChecking=no root@${backend_ip} "mv /tmp/backend.env /root/app/backend/.env"
...
ssh -o StrictHostKeyChecking=no root@${storefront_ip} "mv /tmp/storefront.env /root/app/storefront/.env.local"
